...
static const char qt_meta_stringdata_TeamView[] = {
    ...
    "number\0numberChanged(int)\0port\0"
    "portChanged(QString)\0setPort(int)\0"
    "location\0locationChanged(QString)\0"
    "config\0wlanConfigChanged(QString)\0"
    "build\0buildConfigChanged(QString)\0"
};
...
void TeamView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->portChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 3: _t->setPort((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 4: _t->locationChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 5: _t->wlanConfigChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 6: _t->buildConfigChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
